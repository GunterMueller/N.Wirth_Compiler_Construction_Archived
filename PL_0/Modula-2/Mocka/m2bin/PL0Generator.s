...
PL0Generator_EndGenerator:
	...
	subl	$.Lab1, %esp
.LN1:
	.stabn  68,0,45,.LN1-PL0Generator_EndGenerator		# line 45, column 5
.LBB1:
.LN2:
	.stabn  68,0,46,.LN2-PL0Generator_EndGenerator		# line 46, column 0
.LBE1:
	leave
	ret
	.Lab1 = 4
...
PL0Generator_fixup:
	...
	subl	$.Lab2, %esp
.LN3:
	.stabn  68,0,39,.LN3-PL0Generator_fixup		# line 39, column 5
.LBB2:
.LN4:
	.stabn  68,0,39,.LN4-PL0Generator_fixup		# line 39, column 21
	movl	8(%ebp),%eax
	cmpl	$1023,%eax
	jbe	.Lab3
.Lab4:
...
.LN5:
	.stabn  68,0,40,.LN5-PL0Generator_fixup		# line 40, column 0
.LBE2:
	leave
	ret
	.Lab2 = 4
...
PL0Generator_Gen:
	...
	subl	$.Lab7, %esp
.LN6:
	.stabn  68,0,25,.LN6-PL0Generator_Gen		# line 25, column 5
.LBB3:
.LN7:
	.stabn  68,0,26,.LN7-PL0Generator_Gen		# line 26, column 7
	cmpl	$1023,PL0Generator_s
	jb	.Lab8
.Lab9:
.LN8:
	.stabn  68,0,26,.LN8-PL0Generator_Gen		# line 26, column 28
	call	exit_
.Lab8:
	movl	PL0Generator_s,%eax
	cmpl	$1023,%eax
...
.Lab10:
	...
	movl	%eax,-8(%ebp) 
.LN9:
	.stabn  68,0,28,.LN9-PL0Generator_Gen		# line 28, column 16
	movl	-8(%ebp),%ebx
	movl	8(%ebp),%eax
	cmpl	$15,%eax
	jbe	.Lab12
...
.Lab12:
	movl	%eax,(%ebx) 
.LN10:
	.stabn  68,0,28,.LN10-PL0Generator_Gen		# line 28, column 26
	movl	-8(%ebp),%ebx
	movl	12(%ebp),%eax
	cmpl	$15,%eax
	jbe	.Lab14
...
.Lab14:
	movl	%eax,4(%ebx) 
.LN11:
	.stabn  68,0,28,.LN11-PL0Generator_Gen		# line 28, column 35
	movl	-8(%ebp),%ebx
	movl	16(%ebp),%eax
	cmpl	$1023,%eax
	jbe	.Lab16
...
.Lab16:
	movl	%eax,8(%ebx) 
.LN12:
	.stabn  68,0,34,.LN12-PL0Generator_Gen		# line 34, column 8
	incl	PL0Generator_s
.LN13:
	.stabn  68,0,35,.LN13-PL0Generator_Gen		# line 35, column 0
.LBE3:
	leave
	ret
	.Lab7 = 8
...
PL0Generator_Label:
	...
	subl	$.Lab18, %esp
.LN14:
	.stabn  68,0,21,.LN14-PL0Generator_Label		# line 21, column 5
.LBB4:
.LN15:
	.stabn  68,0,21,.LN15-PL0Generator_Label		# line 21, column 11
	movl	PL0Generator_s,%eax
	leave
	ret
.LN16:
	.stabn  68,0,22,.LN16-PL0Generator_Label		# line 22, column 0
	call	ReturnErr_
.LBE4:
	leave
	ret
...
PL0Generator_InitGenerator:
	...
	subl	$.Lab19, %esp
.LN17:
	.stabn  68,0,17,.LN17-PL0Generator_InitGenerator		# line 17, column 5
.LBB5:
.LN18:
	.stabn  68,0,17,.LN18-PL0Generator_InitGenerator		# line 17, column 13
	movl	$0,PL0Generator_s 
.LN19:
	.stabn  68,0,18,.LN19-PL0Generator_InitGenerator		# line 18, column 0
.LBE5:
	leave
	ret
	.Lab19 = 4
...
PL0Generator:
	...
	subl	$.Lab20, %esp
.LN20:
	.stabn  68,0,48,.LN20-PL0Generator		# line 48, column 2
.LBB6:
.LN21:
	.stabn  68,0,50,.LN21-PL0Generator		# line 50, column 24
	.data
.Lab21:
 	.ascii	"LIT\000"
	.text
...
.LN22:
	.stabn  68,0,50,.LN22-PL0Generator		# line 50, column 47
	.data
.Lab22:
 	.ascii	"OPR\000"
	.text
...
.LN23:
	.stabn  68,0,51,.LN23-PL0Generator		# line 51, column 24
	.data
.Lab23:
 	.ascii	"LOD\000"
	.text
...
.LN24:
	.stabn  68,0,51,.LN24-PL0Generator		# line 51, column 47
	.data
.Lab24:
 	.ascii	"STO\000"
	.text
...
.LN25:
	.stabn  68,0,52,.LN25-PL0Generator		# line 52, column 24
	.data
.Lab25:
 	.ascii	"CAL\000"
	.text
...
.LN26:
	.stabn  68,0,52,.LN26-PL0Generator		# line 52, column 47
	.data
.Lab26:
 	.ascii	"INT\000"
	.text
...
.LN27:
	.stabn  68,0,53,.LN27-PL0Generator		# line 53, column 24
	.data
.Lab27:
 	.ascii	"JMP\000"
	.text
...
.LN28:
	.stabn  68,0,53,.LN28-PL0Generator		# line 53, column 47
	.data
.Lab28:
 	.ascii	"JPC\000"
	.text
...
.LN29:
	.stabn  68,0,54,.LN29-PL0Generator		# line 54, column 0
.LBE6:
	leave
	ret
	.Lab20 = 4

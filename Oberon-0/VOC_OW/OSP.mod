 ...
 *)
  ...
  PROCEDURE enter(name: OSS.Ident; cl: INTEGER; n: LONGINT;  type: OSG.Type);
    VAR obj: OSG.Object;
  BEGIN NEW(obj);
...
BEGIN Texts.OpenWriter(W); Texts.WriteString(W, "Oberon-0 Compiler OSP  30.10.2013");
